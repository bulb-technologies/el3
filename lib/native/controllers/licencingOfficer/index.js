(function(){
  ...
  module.exports = function(cache){
    ...
    app.get('/taxes', mValidation.getTaxes, mLicencingOfficer.getTaxes(cache), function(req, res){
    ...
    //create tax token
    app.post('/token', mLicencingOfficer.createToken(cache), function(req, res){

      res.set('X-Token-Auth', req.tmp.authPair);
